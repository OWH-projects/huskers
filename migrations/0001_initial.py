    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transfer_status', models.CharField(blank=True, max_length=20, null=True, choices=[(b'Junior college', b'Junior college'), (b'University', b'University')])),
                ...
                ('decommit_date', models.DateField(null=True, blank=True)),
                ('official_visit_date', models.DateField(null=True, blank=True)),
