    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio_huskers', models.CharField(help_text=b'Link to Huskers.com bio', max_length=200, null=True, blank=True)),
                ...
                ('player_twitter', models.CharField(help_text=b'Username only. No @ symbol.', max_length=100, null=True, blank=True)),
                ('player_instagram', models.CharField(help_text=b'Username only. No @ symbol.', max_length=100, null=True, blank=True)),
